...
class HrContractInherit(models.Model):
    ...
    contrat_categorie = fields.Selection(
        [("cdi", "CDI"), ("cdd", "CDD"), ("stagiaire", "Stagiaire")],
    ...
    production_bonus_participant = fields.Monetary("Prime de production")
    participation_cantine = fields.Monetary("Participation cantine")
